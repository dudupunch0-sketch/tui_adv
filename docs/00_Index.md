...
docs/
  ...
  runtime preview sources/
    src/tui_adv/storypack-previews/wuxia_jianghu_pack/ # wuxia_commute_rift_arrival부터 wuxia_mumyeong_midgame_reunion까지 preview source YAML; 다음 handoff는 wuxia_mumyeong_followup_after_midgame_reunion
...
2. `wuxia_jianghu_pack` / 이구학지 — 천기록 preview는 `wuxia_mumyeong_midgame_reunion`까지 구현 완료. 다음 handoff는 `wuxia_mumyeong_followup_after_midgame_reunion`
