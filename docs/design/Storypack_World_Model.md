...
- 상태: 설계 문서화 + machine-readable storypack DB 검증 + preview mode 결정 + 무협 서른네 개 preview runtime + Web/terminal default 이구학지 wiring 완료.
