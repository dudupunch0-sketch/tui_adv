...
- 다음 추천: `route_midgame_continuity_after_wounded_shelter` docs-only handoff에서 post-opener midgame continuity 후보를 고른다. 기본 office bundle/legacy `escape-office` key/천외편린 3택 성장/return system/faction route graph/debt ledger schema는 변경하지 않는다.
