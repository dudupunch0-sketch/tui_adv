...
docs/
  ...
  runtime preview sources/
    src/tui_adv/storypack-previews/wuxia_jianghu_pack/ # wuxia_commute_rift_arrival부터 wuxia_mumyeong_destroys_orthodox_sect까지 preview source YAML
...
2. `wuxia_jianghu_pack` / 이구학지 — 천기록 preview/main은 `wuxia_mumyeong_destroys_orthodox_sect`까지 구현 완료. 다음은 `wuxia_mumyeong_destroys_orthodox_sect_followup` docs-only handoff
