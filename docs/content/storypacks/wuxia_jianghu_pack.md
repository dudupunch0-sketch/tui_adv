...
39. `wuxia_battle_loss_epilogue_contract` — runtime 구현 완료
   ...
   - full `wuxia_sado_final_battle`, combat resolver, HP 숫자전, playable defeat route, main ending archive/save surface, relation/debt/faction ledger, reward/ability schema는 열지 않는다. 다음 handoff 후보는 `wuxia_battle_loss_epilogue_followup_handoff`다.
