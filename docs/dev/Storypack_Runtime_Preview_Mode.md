...
Latest epilogue runtime output: `epilogue_state_audit` body block from Rust GameCore. The next contract decision is `wuxia_sado_final_battle_container_followup_handoff`.
