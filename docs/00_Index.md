...
docs/
  ...
  runtime preview sources/
    src/tui_adv/storypack-previews/wuxia_jianghu_pack/ # wuxia_commute_rift_arrival부터 wuxia_mumyeong_reads_orthodox_style까지 preview source YAML; next handoff는 wuxia_mumyeong_followup_after_orthodox_style_trace
