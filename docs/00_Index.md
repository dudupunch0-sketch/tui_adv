...
docs/
  ...
  runtime preview sources/
    src/tui_adv/storypack-previews/wuxia_jianghu_pack/ # wuxia_commute_rift_arrival부터 wuxia_mumyeong_reads_orthodox_style까지 preview source YAML; 다음 runtime 후보는 wuxia_mumyeong_midgame_reunion
...
2. `wuxia_jianghu_pack` / 이구학지 — 천기록 preview는 `wuxia_mumyeong_reads_orthodox_style`까지 구현 완료. 다음 runtime 후보는 `wuxia_mumyeong_midgame_reunion`
