...
- `wuxia_heavenly_archive_previous_outsiders`, `wuxia_wounded_shelter_dawn_offers`, `wuxia_mumyeong_first_sighting` preview도 완료했다.
...
- 다음 handoff는 `wuxia_mumyeong_first_confrontation_after_sighting`다. post-opener any-of condition, route graph, faction reputation, debt/relation/combat schema는 아직 열지 않는다.
