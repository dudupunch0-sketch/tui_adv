...
window.TUI_ADV_IMPLEMENTATION.overview = {
  ...
  highlights: [
    ...
    "Vite 브라우저 fake-TUI shell, localStorage 저장, 복합기 pretext/Canvas anomaly panel",
    "YAML 공개 콘텐츠를 브라우저 JSON으로 export/check하는 스크립트",
    "탈출, 정복, 진실, 히든 현실 연결 루트 smoke 검증"
  ],
  nextWork: [
    "실제 Textual 화면에서 저장 슬롯 UX 수동 QA",
    "브라우저 fake-TUI에서 선택 불가 이유, 이동 단축키, 더 많은 루트 포팅",
  ...
  sources: [
    ...
    { title: "브라우저 앱", path: "web/", description: "Vite 기반 fake-TUI 수직 슬라이스. YAML에서 생성된 JSON을 읽고 localStorage 저장과 pretext/Canvas anomaly panel을 제공한다." },
