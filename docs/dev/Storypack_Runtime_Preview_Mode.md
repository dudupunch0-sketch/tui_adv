...
Status: 결정 문서 + `wuxia_mumyeong_midgame_reunion` runtime 구현 완료 + `wuxia_mumyeong_followup_after_midgame_reunion` docs-only handoff next
