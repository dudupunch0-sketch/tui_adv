...
- 다음 handoff는 `wuxia_mumyeong_followup_after_first_confrontation`다. 카피 무공 공개/중반 재회/보스 첫 등장 중 다음 runtime 후보를 고르되, post-opener any-of condition, route graph, faction reputation, debt/relation/combat/random copy-style/reward schema는 아직 열지 않는다.
