...
12. `route_opener_followup_after_heavenly_archive` — 다음 docs-only handoff
   - `stabilize_wounded_until_dawn` branch를 받는 deferred-offer card 또는 세 route opener 이후의 첫 midgame continuity card 중 하나를 고른다.
