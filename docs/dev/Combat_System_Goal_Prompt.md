...
- 고급 다수전 AI 행동·조기 tick 중단, 치유량·명줄, 혼합형·각본형 개입 일시정지 흐름, 실제 인카운터 콘텐츠 authoring(Wave 3 Step 2b/2c), 전투 결과 캐싱(현재 매 렌더 재실행), Web/terminal 전투 UI, 기술 비용·호흡 회복률·밸런스 수치는 아직 미구현이다.
