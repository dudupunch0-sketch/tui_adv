...
2. 보안 격리 권한 이후 대표실/로비 같은 추가 정복·탈출 분기 확장
3. 고갈증/저정신력 연출의 단계별 화면 연출 강화
