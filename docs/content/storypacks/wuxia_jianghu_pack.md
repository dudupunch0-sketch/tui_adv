...
- `route_midgame_continuity_after_wounded_shelter`에서 세 route opener와 deferred-offer 이후 첫 midgame continuity 후보를 비교한다.
- route별 3개 card, 공통 midgame card, 또는 opened flags 기반 schema-less bridge 중 하나를 고르되, runtime YAML/generated artifact는 handoff에서 수정하지 않는다.
